...
/** Wait task */
public class ApiAction extends Task<ApiAction> {
    ...
    public ApiAction(String taskReferenceName) {
        super(taskReferenceName, TaskType.API_ACTION);
        this.httpRequest = new Input();
        this.httpRequest.method = Input.HttpMethod.GET;
        super.input(INPUT_PARAM, httpRequest);
    }

    ApiAction(WorkflowTask workflowTask) {
        super(workflowTask);
    ...
    public ApiAction input(Input httpRequest) {
        this.httpRequest = httpRequest;
        return this;
    }

    public ApiAction url(String url) {
        this.httpRequest.setUri(url);
        return this;
    }

    public ApiAction method(Input.HttpMethod method) {
        this.httpRequest.setMethod(method);
        return this;
    }

    public ApiAction headers(Map<String, Object> headers) {
        this.httpRequest.setHeaders(headers);
        return this;
    }

    public ApiAction body(Object body) {
        this.httpRequest.setBody(body);
        return this;
    }

    public ApiAction readTimeout(int readTimeout) {
