 ...
 */
package com.netflix.conductor.tasks.apiaction;
...
import com.netflix.conductor.tasks.apiaction.providers.RestApiTemplateProvider;
...
import static com.netflix.conductor.common.metadata.tasks.TaskType.TASK_TYPE_API_ACTION;

;
// add this file
/** Task that enables calling another HTTP endpoint as part of its execution */
@Component(TASK_TYPE_API_ACTION)
public class ApiActionTask extends WorkflowSystemTask {

    private static final Logger LOGGER = LoggerFactory.getLogger(ApiActionTask.class);
    ...
    protected RestApiTemplateProvider restTemplateProvider;
    private final String requestParameter;

    @Autowired
    public ApiActionTask(com.netflix.conductor.tasks.apiAction.providers.RestApiTemplateProvider restTemplateProvider, ObjectMapper objectMapper) {
        this(TASK_TYPE_API_ACTION, restTemplateProvider, objectMapper);
    }

    public ApiActionTask(
            String name, com.netflix.conductor.tasks.apiAction.providers.RestApiTemplateProvider restTemplateProvider, ObjectMapper objectMapper) {
        super(name);
